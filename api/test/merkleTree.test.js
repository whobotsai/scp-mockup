...
const { leafHash, buildTree } = require("../src/shared");

// Same tests as keeper/test/merkleTree.test.js -- this is a direct port of the same logic
// (see shared.js's own header), so it needs the same proof against OpenZeppelin's
// MerkleProof.verify-equivalent algorithm to stay honest about correctness independent of
// buildTree's own proofFor.
